...
int fl1itp,fl1otp;
char fl0out[MAXFLN][50], fl0in[MAXFLN][50];
int fl0otp[MAXFLN], fl0itp[MAXFLN];
...
double maxxystep,xelvismin,maxtkstep,maxtmstep,timestep,timestepe,timesum,timedir,timebond;
double plastmark,plastnew,plastnew1,plastold,plastmax;
/**/
/**/
/**/
...
void tdbasecalc1(double, double, int, long int);
void plastic();
/**/
